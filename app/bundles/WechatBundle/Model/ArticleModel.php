...
class ArticleModel extends FormModel
{
    ...
    {
        return $this->em->getRepository('MauticWechatBundle:Article');
    }
     ...
     */
     public function createForm ($entity, $formFactory, $action = null, $options = array())
     {
         if (!$entity instanceof Article) {
             throw new MethodNotAllowedHttpException(array('Article'));
         }
         if (!empty($action)) {
             $options['action'] = $action;
         }
         return $formFactory->create('article', $entity, $options);
     }
